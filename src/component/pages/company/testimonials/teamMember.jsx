...
const teamMember = ({ text, imageUrl, name, title }) => {
  return (
    <div className="flex flex-col items-center px-4 py-6 w-3/12 text-customDarkGray text-center relative">
      <p className="text-base border-2 border-customYellow p-3 pb-8 mb-2 relative">
        {text}
      ...
      <p className="text-base font-bold text-customYellow mt-2">{name}</p>
